                ...
                <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
                        ...
                        <div className="col-span-2">
                            <div className="mb-6">
                                <h1 className="text-3xl card-title mb-3">
                                    {name}
                    ...
                    <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                        ...
                        <div className="stat">
                            ...
                            <div className="stat-value pr-5 text-3xl md:4xl">{public_repos}</div>
                        </div>
                        <div className="stat">
                            <div className="stat-figure text-secondary">
                            ...
                            <div className="stat-value pr-5 text-3xl md:4xl">{public_gists}</div>
                        </div>
                    </div>
                </div>
